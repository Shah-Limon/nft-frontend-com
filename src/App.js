  ...
  const updateMetadata = (metadata) => {
    if (metadata) {
      ...
      if (descriptionMetaTag) {
        descriptionMetaTag.setAttribute("content", metadata.description || "Default Description");
      } else {
    ...
    <body className='home-main header-fixed'>
      <div className='wrapper'>
        ...
        <Routes>
          ...
          ></Route>
          <Route
            path='/user-dashboard/support/:id'
            element={
              <RequireAuth>
          ...
          ></Route>
          <Route
            path='/user-dashboard/ticket/:id'
            element={
              <RequireAuth>
                <ViewTicketMessage></ViewTicketMessage>
              </RequireAuth>
            }
          ></Route>
          <Route
          ...
          <Route
            ...
            element={<ContactMessageSuccessMessage></ContactMessageSuccessMessage>}
          ></Route>
          <Route
            path='/report/:id'
            element={
          ...
          ></Route>
          <Route
            path='/package-title-edit/:id'
            element={
              <RequireAuth>
                <PackageTitleEdit></PackageTitleEdit>
              </RequireAuth>
            }
          ></Route>
          <Route
          ...
          ></Route>
          <Route
            path='/admin/help-desk/open-ticket'
            element={
              <RequireAuth>
                <AdminRoute>
          ...
          ></Route>
          <Route
            path='/admin/help-desk/replied-ticket'
            element={
              <RequireAuth>
                <AdminRoute>
          ...
          ></Route>
          <Route
            path='/admin/help-desk/solved-ticket'
            element={
              <RequireAuth>
                <AdminRoute>
          ...
          <Route
            ...
            element={
              <RequireAuth>
                <AdminRoute>
                  <HomaPageSetting></HomaPageSetting>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
          <Route
            path='/admin/edit-banner-option/:id'
            element={
              <RequireAuth>
                <AdminRoute>
          ...
          <Route
            ...
            element={
              <RequireAuth>
                <AdminRoute>
                  <EditBannerSlider></EditBannerSlider>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
          <Route
            ...
            element={
              <RequireAuth>
                <AdminRoute>
                  <EditFeaturesPage></EditFeaturesPage>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
          ...
          <Route
            ...
            element={
              <RequireAuth>
                <AdminRoute>
                  <SpecialityOptionEdit></SpecialityOptionEdit>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
          <Route
            ...
            element={
              <RequireAuth>
                <AdminRoute>
                  <WhyChooseEdit></WhyChooseEdit>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
          <Route
            path='/admin/road-edit/:id'
            element={
              <RequireAuth>
                <AdminRoute>
                  <EditRoadMaps></EditRoadMaps>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
          ...
          <Route
            ...
            element={
              <RequireAuth>
                <AdminRoute>
                  <TeamMemberEdit></TeamMemberEdit>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
          <Route
            path='/admin/edit-team-title/:id'
            element={
              <RequireAuth>
                <AdminRoute>
          ...
          ></Route>
          <Route
            path='/admin/edit-testimonial-title/:id'
            element={
              <RequireAuth>
                <AdminRoute>
          ...
          ></Route>
          <Route
            path='/admin/edit-footer/:id'
            element={
              <RequireAuth>
                <AdminRoute>
                  <EditFooterLink></EditFooterLink>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
          ...
          ></Route>
          <Route
            path='/admin/edit-contact-page/:id'
            element={
              <RequireAuth>
                <AdminRoute>
                  <ContactPageEdit></ContactPageEdit>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
          ...
          ></Route>
          <Route
            path='/admin/contact-message-unread/'
            element={
              <RequireAuth>
                <AdminRoute>
                  <ContactUsMessagesUnread></ContactUsMessagesUnread>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
          <Route
            path='/admin/contact-message-read/'
            element={
              <RequireAuth>
                <AdminRoute>
                  <ContactUsMessagesRead></ContactUsMessagesRead>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
          <Route
            ...
            element={
              <RequireAuth>
                <AdminRoute>
                  <ContactUsMessageRead></ContactUsMessageRead>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
          ...
          ></Route>
          <Route
            path='/admin/faqs-title/:id'
            element={
              <RequireAuth>
                <AdminRoute>
                  <EditFaqTitle></EditFaqTitle>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
          <Route
            path='/admin/audit-request'
            element={
              <RequireAuth>
                <ManagerRoute>
          ...
          ></Route>
          <Route
            path='/admin/complete-audit-request/'
            element={
              <RequireAuth>
                <ManagerRoute>
                  <CompleteAuditRequest></CompleteAuditRequest>
                </ManagerRoute>
              </RequireAuth>
            }
          ></Route>
          <Route
            path='/admin/incomplete-audit-request/'
            element={
              <RequireAuth>
                <ManagerRoute>
                  <InCompleteAuditRequest></InCompleteAuditRequest>
                </ManagerRoute>
              </RequireAuth>
            }
          ></Route>
          ...
          <Route
            ...
            element={
              <RequireAuth>
                <AdminRoute>
                  <PaymentsRefunded></PaymentsRefunded>
                </AdminRoute>
              </RequireAuth>
            }
          ></Route>
